...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  ...
  <!-- header-top row: width = grid_width -->
      ...
      <div id="header-link-temp"> <a class="home-link" href="<?php print check_url($front_page) ?>" title="<?php print t('Home') ?>"><img src="/sites/default/themes/atlantabike/images/ABC_web_banner_20111.jpg" /></a></div>
